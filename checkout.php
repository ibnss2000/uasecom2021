...
<html>
<head>
<title>SambongShop - Checkout</title>
<!-- for-mobile-apps -->
...
<!-- header -->
	...
	<div class="logo_products">
		<div class="container">
				...
				<h1><a href="index.php">Sambonghop</a></h1>
			</div>
...
<div class="footer">
			...
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						...
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@email">admin@sambongshopemail.com</a></li>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2021SambongShop. All rights reserved</p>
			</div>
		</div>
