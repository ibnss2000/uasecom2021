...
<html>
<head>
<title>SAMBONGSHOP - TEMPAT PRODUK FASHION TERBAIK</title>
<!-- for-mobile-apps -->
				...
				<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
					<div id="myTabContent" class="tab-content">
						<div role="tabpanel" class="tab-pane fade in active" id="expeditions" aria-labelledby="expeditions-tab">
							<div class="agile-tp">
								<h5>Penawaran Terbaik Minggu Ini, Diskon 9%!
								<?php
...
<div class="footer">
			...
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						...
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+62 736721868</li>
					</ul>
				</div>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2020SambongShop. All rights reserved</p>
			</div>
		</div>
